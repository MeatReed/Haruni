  ...
  <v-container>
    <v-row>
      <v-col xl="4" lg="4" md="12" sm="12" xs="12">
        <v-card height="150" color="transparent" outlined>
          <div class="d-flex justify-space-between">
            <div>
              ...
              >
              <v-card-actions>
                <v-btn text href="/support" target="_blank">Join now</v-btn>
              </v-card-actions>
            </div>
    ...
    <v-row>
      <v-col class="text-center">
        ...
        <v-row>
          <v-col class="text-center">
            <v-btn v-if="!this.$store.state.user" href="/login" outlined
              >Login</v-btn
            >
            <v-btn v-else href="/player" outlined>Servers</v-btn>
            <v-btn
              outlined
              target="_blank"
              href="https://discord.com/api/oauth2/authorize?client_id=722181826545713313&permissions=1609887095&scope=bot"
              >Add Haruni</v-btn
            >
            <v-btn href="/support" target="_blank" outlined>Support</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
